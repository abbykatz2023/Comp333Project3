    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='song_rater_app.artist')),
            ],
        ),
        migrations.CreateModel(
            name='Ratings',
            fields=[
                ...
                ('username', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='song_rater_app.user')),
            ],
        ),
    ]
